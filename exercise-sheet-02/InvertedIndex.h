...
#ifndef EXERCISE_SHEET_02_INVERTEDINDEX_H_
#define EXERCISE_SHEET_02_INVERTEDINDEX_H_
...
class InvertedIndex {
 public:
  ...
  const std::vector<Posting> getDocIdsForWord(const std::string& word) const;
...
#endif  // EXERCISE_SHEET_02_INVERTEDINDEX_H_
