...
#ifndef EXERCISE_SHEET_08_INVERTEDINDEX_H_
#define EXERCISE_SHEET_08_INVERTEDINDEX_H_
...
class InvertedIndex {
 public:
  void WriteTermDocumentMatrix(const std::string& filename,
                               const size_t m);
  FRIEND_TEST(InvertedIndexTest, WriteTermDocumentMatrix);
...
#endif  // EXERCISE_SHEET_08_INVERTEDINDEX_H_
